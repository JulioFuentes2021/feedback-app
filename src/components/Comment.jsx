...
const Comment = () => {
	return (
		<article className="p-4 flex flex-col sm:flex-row bg-white">
			<img
			...
			<div>
				...
				<section className="my-7">
					<p className="text-gray-600">
						...
						similique incidunt modi. Aperiam sed consectetur similique optio
						ullam possimus odit consequuntur nesciunt debitis aspernatur soluta
						commodi eum ducimus, fuga ad!
					</p>
				</section>
			</div>
		</article>
